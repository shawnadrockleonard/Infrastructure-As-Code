...
namespace InfrastructureAsCode.Core.Reports.o365Graph.TenantReport.Mappings
{
     ...
     * */
    class SkypeForBusinessOrganizerActivityUserCountsMap : ClassMap<SkypeForBusinessOrganizerActivityUserCounts>
    {
        SkypeForBusinessOrganizerActivityUserCountsMap()
        {

...
namespace IaC.Powershell.Commands.Files
{
    ...
    public class AddIaCFileUpload : IaCCmdlet
    {
        ...
        protected override void BeginProcessing()
        {
            ...
            {
                throw new InvalidOperationException(String.Format("{0} {1}", this.FileName, IaC.Core.Properties.Resources.FileDoesNotExist));
            }
        }

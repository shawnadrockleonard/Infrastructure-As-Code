...
namespace InfrastructureAsCode.Powershell.Commands.Reporting
{
    ...
    public class ReportIaCUsageAnalytics : AzureADALv1Cmdlet
    {
        [Parameter(Mandatory = true)]
        public ReportUsageEnum ReportType { get; set; }

        [Parameter(Mandatory = true)]
        public ReportUsageTypeEnum ReportUsageType { get; set; }
        ...
        public override void ExecuteCmdlet()
        {
            ...
            else
            {
                ...
                else if (ReportType == ReportUsageEnum.Office365Groups)
                {
                ...
                else if (ReportType == ReportUsageEnum.Skype)
                {
                ...
                else if (ReportType == ReportUsageEnum.OneDrive)
                {
                ...
                else if (ReportType == ReportUsageEnum.SharePoint)
                {
